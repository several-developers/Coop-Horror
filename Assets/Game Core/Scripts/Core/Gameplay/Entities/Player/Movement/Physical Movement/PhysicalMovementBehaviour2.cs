...
namespace GameCore.Gameplay.Entities.Player.Movement
{
    public class PhysicalMovementBehaviour2 : IMovementBehaviour
    {
        ...
        public void FixedTick()
        {
            ...
            float inputLerpSpeed = _movementConfig.InputLerpSpeed;
            ...
            if (_isGrounded)
            {
                ...
                {
                    float backwardSpeedPercentage = _movementConfig.BackwardSpeedPercentage;
                ...
                {
                    float strafeSpeedPercentage = _movementConfig.StrafeSpeedPercentage;
            ...
            float diagonalStrafeAmt = _movementConfig.DiagonalStrafeAmt;
            ...
            {
                float gravityMax = _movementConfig.GravityMax;
                ...
                {
                    float airSpeedMultiplier = _movementConfig.AirSpeedMultiplier;
            ...
            {
                AnimationCurve slopeSpeed = _movementConfig.SlopeSpeed;
        ...
        private bool CanStep(Vector3 direction)
        {
            ...
            float stepHeightRadius = _movementConfig.StepHeightRadius;
            float maxStepHeight = _movementConfig.MaxStepHeight;
