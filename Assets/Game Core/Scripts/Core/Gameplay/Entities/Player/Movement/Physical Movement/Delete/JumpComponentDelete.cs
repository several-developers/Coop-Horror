...
{
    public class JumpComponentDelete
    {
        // CONSTRUCTORS: --------------------------------------------------------------------------

        public JumpComponentDelete(PlayerEntity playerEntity, PhysicalMovementBehaviour2 movementBehaviour)
        {
        ...
        private MovementComponentDelete _movementComponent;
        ...
        public void Init() =>
            _movementComponent = _movementBehaviour.MovementComponentDelete;
