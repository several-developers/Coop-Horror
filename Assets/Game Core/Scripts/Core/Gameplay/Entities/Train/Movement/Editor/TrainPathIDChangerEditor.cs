...
{
    [CustomEditor(typeof(TrainPathIDChanger))]
    public class TrainPathIDChangerEditor : OdinEditor
    {
        // PUBLIC METHODS: ------------------------------------------------------------------------

        [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected | GizmoType.InSelectionHierarchy |
                   GizmoType.NotInSelectionHierarchy)]
        public static void RenderCustomGizmo(TrainPathIDChanger obj, GizmoType gizmo)
        {
