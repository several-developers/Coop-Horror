...
{
    [CustomEditor(typeof(MetroDoorTeleportPointDrawer))]
    public class MetroDoorTeleportPointDrawerEditor : OdinEditor
    {
        // FIELDS: --------------------------------------------------------------------------------
        ...
        public static void RenderCustomGizmo(MetroDoorTeleportPointDrawer obj, GizmoType gizmo)
        {
