...
namespace GameCore.Infrastructure.StateMachine
{
    public class SignInState : IEnterStateAsync
    {
        ...
        public SignInState(IGameStateMachine gameStateMachine, LocalLobby localLobby, LocalLobbyUser localUser,
            ProfileManager profileManager, AuthenticationServiceFacade authenticationServiceFacade)
        {
