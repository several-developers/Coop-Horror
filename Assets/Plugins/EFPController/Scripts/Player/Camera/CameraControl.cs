    ...
    public class CameraControl : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            camPos = tempLerpPos + (playerTransform.right *
                                    (cameraRootAnimations.camPosAnim.x * cameraBobAnims.camPositionBobAmt.x))
                                 + new Vector3(0f,
                                     dampOrg + (cameraRootAnimations.camPosAnim.y * cameraBobAnims.camPositionBobAmt.y),
            ...
            tempCamAngles = Quaternion.Euler(transform.localEulerAngles.x -
                                             (cameraRootAnimations.camAngleAnim.y * cameraBobAnims.camAngleBobAmt.y *
                                              deltaAmt)
                                             + (CameraAnglesAnimTemp.x * deltaAmt), // camera pitch modifiers
                transform.localEulerAngles.y -
                (cameraRootAnimations.camAngleAnim.x * cameraBobAnims.camAngleBobAmt.x * deltaAmt)
