...
namespace Sonity.Internal {
    ...
    public abstract class SoundEventEditorBase : Editor {
        ...
        //// SoundEvent new volume fixing
        //public SerializedProperty expandVolume;
        ...
        public void FindProperties() {
            ...
            //// SoundEvent new volume fixing
            //expandVolume = data.FindPropertyRelative(nameof(SoundEventInternalsData.expandVolume));
        ...
        private void GuiVolume() {
            ...
            //BeginChange();
            //EditorGuiFunction.DrawFoldout(expandVolume, "Volume", "");
            //EndChange();

            //if (expandVolume.boolValue) {
            //    BeginChange();
            ...
            //            mTargets[i].internals.data.volumeDecibel = Mathf.Clamp(mTargets[i].internals.data.volumeDecibel - 1f, VolumeScale.lowestVolumeDecibel, 0f);
                ...
                if (ShouldDebug.GuiWarnings()) {
                    if (mTarget.internals.data.GetIfInfiniteLoop(mTarget, out SoundEventBase infiniteInstigator, out SoundEventBase infinitePrevious, TriggerOnType.TriggerOnTail)) {
                        ...
                        EditorGUILayout.HelpBox(
                            "\"" + infiniteInstigator.name + "\" in \"" + infinitePrevious.name + "\" creates an infinite loop" +
                            "\n" +
        ...
        private void GuiSoundTag() {
            StartBackgroundColor(EditorColor.GetTag(EditorColorProSkin.GetCustomEditorBackgroundAlpha()));
            BeginChange();
