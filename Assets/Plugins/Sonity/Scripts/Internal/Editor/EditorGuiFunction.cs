...
namespace Sonity.Internal {
    public static class EditorGuiFunction {
        ...
        public static void DrawLabel(string title, string tooltip = "", bool drawBackground = true, bool center = true, bool smallFont = false, bool useSmallerLabel = false, bool skipGuiStyle = false) {
