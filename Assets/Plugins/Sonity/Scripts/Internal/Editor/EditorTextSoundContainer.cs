...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundContainer {
        ...
        public static string audioMixerGroupTooltip =
            ...
            "\n" +
            $"The {nameof(NameOf.SoundEvent)}s AudioMixerGroup overrides the {nameof(NameOf.SoundContainer)}s AudioMixerGroup." + "\n" +
            "\n" +
            $"Performance tips:" + "\n" +
            "\n" +
            ...
            "\n" +
            $"If you need to increase performance, look at {nameof(NameOf.SoundMix)} assets for controlling volume hierarchically." + EditorTrial.trialTooltip;
        ...
        public static string volumeTooltip = "The volume in dB." + EditorTrial.trialTooltip;
        ...
        public static string volumeRelativeIncreaseTooltip =
            ...
            "\n" +
            $"Stops if any of the selected {nameof(NameOf.SoundContainer)} reaches 0 db." + "\n" +
            "\n" +
