...
namespace Sonity.Internal {
    ...
    public class SoundManagerVoicePool {
        ...
        [NonSerialized]
        private Dictionary<SoundPolyGroupBase, SoundPolyGroupDictionaryValue> soundPolyGroupDictionary = new Dictionary<SoundPolyGroupBase, SoundPolyGroupDictionaryValue>();
