...
namespace Sonity.Internal {
    ...
    public class SoundManagerInternals {
        ...
        [NonSerialized]
        public Dictionary<SoundPhysicsConditionBase, CheckedDictionaryValueSoundPhysicsCondition> checkedDictionarySoundPhysicsCondition = new Dictionary<SoundPhysicsConditionBase, CheckedDictionaryValueSoundPhysicsCondition>();
        ...
        public void ManagedUpdate() {
            ...
            while (managedUpdateTempInstanceDictionaryValueEnumerator.MoveNext()) {
                ...
                if (managedUpdateTempInstanceDictionaryValueEnumerator.Current.Key == null) {
                    toDeleteAdded = true;
        ...
        [NonSerialized]
        private List<Dictionary<SoundEventBase, SoundEventInstanceDictionaryValue>.Enumerator> toDeleteInstances = new List<Dictionary<SoundEventBase, SoundEventInstanceDictionaryValue>.Enumerator>();
        ...
        public bool InternalCheckSoundPhysicsConditionIsInfiniteLoop(SoundPhysicsConditionBase condition) {
            ...
            if (!checkedDictionarySoundPhysicsCondition.TryGetValue(condition, out checkedDictionaryValueSoundPhysicsCondition)) {
                checkedDictionaryValueSoundPhysicsCondition = new CheckedDictionaryValueSoundPhysicsCondition();
                checkedDictionarySoundPhysicsCondition.Add(condition, checkedDictionaryValueSoundPhysicsCondition);
            }
